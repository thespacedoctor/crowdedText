...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/crowdedText.rst']
...
modindex_common_prefix = ["crowdedText."]
...
latex_documents = [
    ('index', 'crowdedText.tex', u'crowdedText Documentation',
     u'Dave Young', 'manual'),
]
...
def updateUsageRST():
    ...
    from crowdedText import cl_utils
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["crowdedText"]
    allSubpackages += findAllSubpackges(
        pathToPackage="crowdedText"
    )
